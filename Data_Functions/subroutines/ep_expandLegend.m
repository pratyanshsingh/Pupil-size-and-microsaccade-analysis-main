...
switch theFunction
    case 'EPwaves'
        uicontrol('Style', 'pushbutton', 'String', 'Cancel','FontSize',EPmain.fontsize,...
            'Position', [20 10 60 30], 'Callback', ['global EPmain;','close(EPmain.expandChan.handles.expandLegend.figure);']);
        uicontrol('Style', 'pushbutton', 'String', 'Done','FontSize',EPmain.fontsize,...
            'Position', [90 10 60 30], 'Callback', ['global EPwaves EPmain;','legendNames=get(EPmain.expandChan.handles.expandLegend.table,''Data'');','set(EPmain.expandChan.handles.legend,''String'',legendNames);','EPwaves.legendNames=legendNames;','close(EPmain.expandChan.handles.expandLegend.figure);']);
    case 'EPtopos'
        uicontrol('Style', 'pushbutton', 'String', 'Cancel','FontSize',EPmain.fontsize,...
            'Position', [20 10 60 30], 'Callback', ['global EPmain;','close(EPmain.expandChan.handles.expandLegend.figure);']);
        uicontrol('Style', 'pushbutton', 'String', 'Done','FontSize',EPmain.fontsize,...
            'Position', [90 10 60 30], 'Callback', ['global EPtopos EPmain;','legendNames=get(EPmain.expandChan.handles.expandLegend.table,''Data'');','set(EPmain.expandChan.handles.legend,''String'',legendNames);','EPtopos.legendNames=legendNames;','close(EPmain.expandChan.handles.expandLegend.figure);']);
end
